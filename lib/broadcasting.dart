/// Broadcasting is an SDK that allows you to communicate with
/// Broadcasting Data Streaming Network in a fast and easy manner.
///
/// The best starting point to take a look around is the [Broadcasting] class that combines all available features.
