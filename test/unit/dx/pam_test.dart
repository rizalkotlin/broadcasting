...
import 'package:broadcasting/src/default.dart';
import 'package:broadcasting/src/dx/_utils/utils.dart';
import 'package:broadcasting/src/dx/pam/resource.dart';
...
void main() {
  ...
  group('DX [PAM]', () {
    final currentVersion = Broadcasting.version;

    setUp(() {
      Broadcasting.version = '1.0.0';
      Core.version = '1.0.0';
    ...
    tearDown(() {
      Broadcasting.version = currentVersion;
