...
import 'package:broadcasting/src/dx/channel/channel.dart';
import 'package:broadcasting/src/dx/channel/channel_history.dart';
      ...
      group('[ChannelHistory]', () {
        ...
        test('#count should send correct request and return an int', () async {
          when(
            method: 'GET',
            path:
                'v3/history/sub-key/test/message-counts/test?timetoken=1&uuid=test&pnsdk=PubNub-Dart%2F${Broadcasting.version}',
        ...
        test('#delete should send correct request', () async {
          when(
            method: 'DELETE',
            path:
                'v3/history/sub-key/test/channel/test?uuid=test&pnsdk=PubNub-Dart%2F${Broadcasting.version}',
        ...
        test('#fetch should send correct request', () async {
          when(
            method: 'GET',
            path:
                'v2/history/sub-key/test/channel/test?count=100&reverse=true&include_token=true&uuid=test&pnsdk=PubNub-Dart%2F${Broadcasting.version}',
      ...
      group('[PaginatedChannelHistory]', () {
        ...
        test('#more should fetch messages', () async {
          when(
            method: 'GET',
            path:
                'v2/history/sub-key/test/channel/test?count=100&reverse=false&include_token=true&uuid=test&pnsdk=PubNub-Dart%2F${Broadcasting.version}',
